...
1. where Brand appears in those answers, as in at least you should be visible or in the radar of the chat-search apps
2. how are you being placed in your domain in what context
3. hence know what to investigate next, and the decision will be how to improve your content game
...
- add context labels like "positive","negative" etc.
